...
|   Residental Sales | NERC.REGION   |   Residental Percentage |   POPULATION | CAUSE.CATEGORY     |   CUSTOMERS.AFFECTED |   RES.CUST.PCT |   IND.CUST.PCT |   YEAR | Start Time          | End Time            |   Year | Duration        |   Duration Minutes |
|-------------------:|:--------------|------------------------:|-------------:|:-------------------|---------------------:|---------------:|---------------:|-------:|:--------------------|:--------------------|-------:|:----------------|-------------------:|
